...
const (
	...
	Msg_SetMemo_FullMethodName          = "/noble.forwarding.v1.Msg/SetMemo"
)
...
func (c *msgClient) SetMemo(ctx context.Context, in *MsgSetMemo, opts ...grpc.CallOption) (*MsgSetMemoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SetMemo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) SetMemo(context.Context, *MsgSetMemo) (*MsgSetMemoResponse, error) {
...
func _Msg_SetMemo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SetMemo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
